...
#define BOARD_MKS_ROBIN_GEN     556  //MKS RobinLite board
#define BOARD_MKS_ROBIN_MINI    557  //MKS RobinLite board
#define BOARD_MKS_ROBIN_PLUS    558  //MKS RobinLite board
*/
